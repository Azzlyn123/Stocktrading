      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          <div className="flex items-center gap-2 mb-8">
            ...
            <div>
              <h1 className="text-xl font-semibold tracking-tight">BreakoutIQ</h1>
              <p className="text-xs text-muted-foreground">Intraday Trading Alerts</p>
            </div>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-card items-center justify-center p-12">
        <div className="max-w-md space-y-8">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Multi-timeframe strategy scanning the top US equities and ETFs.
            Get "SETUP forming" and "TRIGGER hit" alerts with precise entry,
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Multi-timeframe confirmation with EMA slope analysis</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-md bg-accent flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Daily loss limits, cooldowns, and position sizing</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-md bg-accent flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Setup forming and trigger hit notifications</p>
              </div>
            </div>
          </div>
        </div>
